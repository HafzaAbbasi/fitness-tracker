...
//             //  Store email in session after signup
...
//               userId: newId,
//               email // send email to frontend if needed
//             });
//           }
//         );
//       });
...
// // =================== CHECK DIET PLAN (NEW ROUTE) ===================
// // ✅ Check if logged-in user already has a diet plan
...
//   }
//   try {
//     // Fetch workout suggestions from DB
...
//     // Fetch diet plan from Spoonacular API
...
//       : "No meal plan found";
//     // Handle food replacements for allergies
...
//   }});
// // =================== GET PLAN AGAIN FOR EXISTING USERS ===================
